    ...
    <div id="login-window">
      ...
      <div id="userinfo">
        <div id="userinfo-account">
          ...
          <span class="error-note">请正确输入账号</span>
        </div>
        <div id="userinfo-password">
          <Input v-model="password" placeholder="密码" style="width: 300px;" prefix="xxx iconfont icon-password">
            <!--<Icon class="iconfont icon-password" size="24"/>-->
          </Input>
          <span class="error-note">请正确输入密码</span>
        </div>
        <div id="userinfo-key">
